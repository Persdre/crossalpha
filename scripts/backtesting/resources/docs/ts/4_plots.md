...
12 interactive plots visualize strategy performance, factor quality, and risk characteristics.
...
| Plot | Description |
|------|-------------|
| L/S Cumulative Returns | Long/short strategy performance |
| Long Cumulative Returns | Long-only positions |
| Short Cumulative Returns | Short-only positions |
| Long Passive Investment Cumulative Returns | Passive long-only benchmark |
| Short Passive Investment Cumulative Returns | Passive short-only benchmark |
